...
public:
 ...
 //       if (prefs.get("gvle.graphics.label-color", &s) and not s.empty()) {
 //           mLabelColor = convert(s);
 //           s.clear();
 //       }
    ...
    void save()
    {
       ...
       // prefs.set("gvle.graphics.label-color", convert(mLabelColor));
...
//void Settings::setLabelColor(const Gdk::Color& color)
//{
//    settings().mPimpl->mLabelColor = color;
//}

//const Gdk::Color& Settings::getLabelColor() const
//{
//    return settings().mPimpl->mLabelColor;
//}
